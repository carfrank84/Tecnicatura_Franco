...
# hacer un programa que simule una agenda de
# contactos . crear un diccionario donde la clave
# sea el nombre del usuario y el valor
# sea el telefono, el programa tendra el siguiente
# menu de opciones :
#                 1. Nuevo contacto
#                 2. Borrar contacto
