...
# cree las siguientes listas (en la que no debe haber repeticion)
# 1 lista de palabras que aparecen en las listas
#2 lista de palabras que aparecen en la primera lista
# 3 lista de palabras que aparacene en la segunda lista
# 4 lista de palabras que aparcen en ambas listas
